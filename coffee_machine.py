...
def show_status():
    print('Current Status:\n',
          ...
          available_milk, 'milk\n',
          available_coffee_beans, 'coffee beans\n',
...
while True:
    ...
    if action_selected == 'buy':
        ...
        elif coffee_selected == 'back':
            continue
    elif action_selected == 'fill':
    ...
    elif action_selected == 'take':
        print('I will now give you ', available_money)
        change_status(0, 0, 0, -available_money, 0)
    elif action_selected == 'remaining':
        show_status()
    elif action_selected == 'exit':
        break
